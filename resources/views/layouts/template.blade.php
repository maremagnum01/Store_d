...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" style="height:100%; margin: 0">
    <head>
        ...
        <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" integrity="sha512-z3gLpd7yknf1YoNbCzqRKc4qyor8gaKU1qmn+CShxbuBusANI9QpRohGBreCFkKxLhei6S9CQXFEbbKuqLg0DA==" crossorigin="anonymous" referrerpolicy="no-referrer" />      
        <!-- Styles -->
        ...
        <link rel="stylesheet" href="http://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
        <script src="http://code.jquery.com/jquery-3.2.1.slim.min.js"> </script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/popper.js/2.9.2/umd/popper.min.js"></script>
        ...
        <script src="http://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    </head>
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-evenly">
                    <div class="col-4 d-flex justify-content-evenly" style="">
                        ...
                        <div>
                            <a href="http://wa.me/5491131756183" target="_blank" style="text-decoration:none; color:white"><h5>Whatsapp</h5></a>
                    ...
                    <div class="col-4 d-flex justify-content-evenly">
                        ...
                        <div>
                            <a href="http://www.facebook.com/profile.php?id=100075871160712&mibextid=LQQJ4d" target="_blank" style="text-decoration:none; color:white;"><h5>Facebook</h5></a>
